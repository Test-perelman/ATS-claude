 ...
 *
 * This script simulates the team creation flow and tests invariant guards
 */

// Copy the invariant guard functions inline for testing
...
function validateUserTeamConsistency(user) {
...
function validateMembershipState(membership) {
